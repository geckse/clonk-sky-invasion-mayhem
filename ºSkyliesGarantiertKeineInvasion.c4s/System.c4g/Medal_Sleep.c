...
protected func FxSleepNSpellTimer(object pTarget, int iEffectNumber, int iTime) 
{
  ...
  // Alle SleepNSpellEffekte durchgehen und überprüfen, ob sie die gleiche EffectVar(1) haben. Wenn das bei mindestens 4 davon (diesen eingeschlossen) der Fall ist, Medaille vergeben!
  var sleepers = 0;
