...
protected func CannonMobileID() { return(CTC1); }
...
protected func CannonPower(object obj) { return(RandomX(12,17)); }
protected func CannonSound(object obj) { return("Arrow"); }
protected func CannonSmoke(object obj) { return(0); }
